#ifndef __PRATIPO_WS2801__
#define __PRATIPO_WS2801__
...
class Pratipo_WS2801 {

 public:

  // Configurable pins:
  Pratipo_WS2801(uint16_t n, uint8_t dpin, uint8_t cpin, uint8_t order=WS2801_RGB);
  Pratipo_WS2801(uint16_t x, uint16_t y, uint8_t dpin, uint8_t cpin, uint8_t order=WS2801_RGB);
  // Use SPI hardware; specific pins only:
  Pratipo_WS2801(uint16_t n, uint8_t order=WS2801_RGB);
  ...
  void
    ...
    setPixelColor710(uint16_t x, uint16_t y, uint32_t c),
